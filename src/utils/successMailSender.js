...
<div>
    <table align="center" border="0">
        <tbody style="text-align:center">
            ...
            <tr>
                <td style="text-align:center; margin:5px; padding: 5px;">
                    <h2 style="margin: 5px; padding:5px;">Acabamos de registrar tu compra con el siguiente detalle:</h2>
                </td>
            </tr>
                ...
                <td style="text-align:center">
                    <table align="center" border="0" cellpadding="0" style="background-color:#f2f4f8; border:1px solid #d9dbde; border-radius:3px; font-family:arial,sans-serif; max-width:700px; width:100%">
                        <tbody>
                            ...
                            <tr>
                            <!-- {/* Sacado del objeto que devuelve MercadoPago */} -->
                                <td style="text-align:center; font-size:15px; padding:5px 5px 16px 5px;">${moneda} ${monto_total}</td>
                            <tr>
            ...
            <tr>
                <td style="text-align:center"><br/>
                    <strong>
                        ¿Dudas o consultas? Comunícate con nosotros a través de los siguientes canales de diálogo:
                    </strong>
                </td>
            </tr>
